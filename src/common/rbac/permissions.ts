...
export const ROLE_PERMISSIONS: Record<EdifyRole, PermissionKey[]> = {
  ...
  CountryDirector: [
    ...
    P.PLANNING_VIEW, P.PLANNING_CREATE, P.ACTIVITY_ASSIGN, P.EVIDENCE_REVIEW,
    P.BUDGET_VIEW_SUMMARY, P.BUDGET_VIEW_DETAIL, P.BUDGET_APPROVE, P.STAFF_MANAGE,
    P.PARTNER_VIEW, P.PROJECT_MANAGE, P.ANALYTICS_VIEW, P.EXPORT,
  ],
  ...
  ImpactAssessment: [
    ...
    P.CLUSTER_VIEW, P.CLUSTER_ASSIGN, P.SSA_VIEW, P.SSA_UPLOAD, P.PLANNING_VIEW,
    P.EVIDENCE_REVIEW, P.IA_VERIFY, P.ANALYTICS_VIEW, P.EXPORT,
  ],
  ProgramAccountant: [
